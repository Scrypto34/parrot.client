...
namespace Parrot.client.Mods
{
    public class Movement
    {
        ...
        public static void Pull()
        {
            ...
            Vector3 dir = GorillaTagger.Instance.headCollider.transform.forward;
            rb.linearVelocity += dir * pullSpeed * Time.deltaTime;

            if (GTPlayer.Instance.RightHand.wasColliding)
                rb.linearVelocity += -GTPlayer.Instance.RightHand.controllerTransform.up * wallAssistAmount;

            if (GTPlayer.Instance.LeftHand.wasColliding)
                rb.linearVelocity += -GTPlayer.Instance.LeftHand.controllerTransform.up * wallAssistAmount;
        }
        ...
        {
            GorillaLocomotion.GTPlayer.Instance.jumpMultiplier = 2;
            GorillaLocomotion.GTPlayer.Instance.maxJumpSpeed = 8f;
        }

        public static void IshowSpeedJR()
        {
            GorillaLocomotion.GTPlayer.Instance.jumpMultiplier = 65;
