    ...
    public class Buttons
    {
        ...
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] {
                ...
                new ButtonInfo { buttonText = "Speed Boost", method =() => Movement.SpeedBoost(), toolTip = "Increases your jump speed and multiplier."},
                new ButtonInfo { buttonText = "IShowSpeedJR", method =() => Movement.IshowSpeedJR(), toolTip = "Increases your jump speed and multiplier."},
            ...
            new ButtonInfo [] {
                ...
                new ButtonInfo { buttonText = "Jarvis (Hold X)", method = () => Mods.Jarvis.Jarvis.Tick(), disableMethod = () => Mods.Jarvis.Jarvis.Stop(), toolTip = "AI voice assistant. Hold X (or V on PC), talk, release. Needs a Gemini key in gemini.txt." },
                new ButtonInfo { buttonText = "Jarvis Speaks", enableMethod = () => Mods.Jarvis.Jarvis.Speak = true, disableMethod = () => Mods.Jarvis.Jarvis.Speak = false, enabled = Mods.Jarvis.Jarvis.Speak, toolTip = "On: Jarvis talks back with a voice. Off: replies show as a notification only." },
                new ButtonInfo { buttonText = "Spam Bracelet", method = () => Overpowered.SpamBracelet(), toolTip = "Rapidly toggles your bracelet on and off." },
                new ButtonInfo { buttonText = "Ghost Monkey (RP)", method = () => Fun.GhostMonkey(), disableMethod = () => { GorillaTagger.Instance.offlineVRRig.enabled = true; }, toolTip = "Hold right primary to go invisible, release to come back." },
