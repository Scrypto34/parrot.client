    ...
    public class Buttons
    {
        ...
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] {
                ...
                new ButtonInfo { buttonText = "Motion Trail", method =() => Mods.MotionTrail.Apply(), disableMethod =() => Mods.MotionTrail.Stop(), toolTip = "Leaves a glowing trail behind you in your menu theme color as you move."},
            ...
            new ButtonInfo [] {
                ...
                new ButtonInfo { buttonText = "Draw Mod (RG)", method = () => DrawMod.Draw(), disableMethod = () => DrawMod.StopDraw(), toolTip = "Hold right grip to draw dots in the air. Left grip also draws while active. Right primary changes color." },
