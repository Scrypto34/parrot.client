...
{
    public class CartiJacksonSync : IOnEventCallback
    {
        private const byte EventCode = 183;
        private const string Marker = "PARROTCARTIJ";
        private const float HeartbeatRate = 2f;
        private const float Timeout = 6f;

        private static CartiJacksonSync instance;
        ...
        private static void SpawnRemote(int actor)
        {
            ...
            remote[actor] = CartiJackson.Spawn();
        }
