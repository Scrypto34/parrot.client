...
{
    public class CartiSync : IOnEventCallback
    {
        private const byte EventCode = 182;
        private const string Marker = "PARROTCARTI";
        private const float HeartbeatRate = 2f;
        private const float Timeout = 6f;

        private static CartiSync instance;
        ...
        private static void SpawnRemote(int actor)
        {
            ...
            remote[actor] = TravisScott.Spawn();
        }
